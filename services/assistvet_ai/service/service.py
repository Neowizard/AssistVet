...
@provet_mcp.tool("provet_appointments",
                 description="Gets appointments from Provet from date to date (given in YYYY-MM-DD format)")
async def get_provet_appointments(from_date: str, to_date: str) -> AppointmentsResponse:
    """
    Get the appointments scheduled in the Provet system for a given date range provided as YYYY-MM-DD.
    """
